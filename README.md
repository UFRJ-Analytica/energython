...
## Arquitetura em três elos

A solução foi estruturada em três elos principais.

---

### Elo 1 — Físico / Preditivo

O primeiro elo responde:

> Qual é o risco de uma usina sofrer curtailment nas próximas horas ou dias?

Esse módulo utiliza dados históricos e variáveis externas para estimar:

- probabilidade de corte;
- magnitude esperada do corte em MWh;
- comportamento temporal por usina;
- risco por submercado;
- padrões de geração e restrição.

Possíveis variáveis utilizadas:

- histórico de constrained-off;
- geração verificada;
- geração de referência;
- fonte da usina: solar ou eólica;
- potência instalada;
- submercado;
- PLD;
- dados climáticos;
...
- hora do dia;
- dia da semana;
- médias móveis de eventos anteriores.

No MVP, esse elo foi pensado para operar com modelos tabulares, como Random Forest, LightGBM ou modelos de fallback sazonal, sempre respeitando validação temporal.

---

### Elo 2 — Financeiro

O segundo elo responde:

> Quanto o gerador perdeu financeiramente com os cortes?

Esse módulo transforma o evento físico de curtailment em impacto financeiro.
