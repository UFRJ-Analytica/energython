...
export const getDebugLabTemplate = (id: string, dias = 30, limitSerie = 200) =>
  get<DebugLabOut>(`/debug/usinas/${encodeURIComponent(id)}/lab-template?dias=${dias}&limit_serie=${limitSerie}`)
