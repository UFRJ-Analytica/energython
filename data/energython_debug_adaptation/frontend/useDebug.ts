...
export const useDebugLabTemplate = (id: string, dias = 30, limitSerie = 200) =>
  useQuery({
    queryKey: ["debug", "lab-template", id, dias, limitSerie],
    queryFn: () => getDebugLabTemplate(id, dias, limitSerie),
    enabled: !!id,
  })
