...
export function FinanceiroTab({ usinaId, inicio, fim }: Props) {
  ...
  const pldMedioReaisMwh = data.total_energia_restringida_mwh > 0 ? data.total_perda_reais / data.total_energia_restringida_mwh : 0
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <KpiCard title="Eventos de restrição" value={String(totalEventos)} sub="eventos agregados" />
        <KpiCard title="PLD médio" value={`${fmtBRL(pldMedioReaisMwh)}/MWh`} sub="ponderado pela energia perdida" />
      </div>
